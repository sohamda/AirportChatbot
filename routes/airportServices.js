...
var getFlightDetails = function(flightNo) {
	...
	{
	  console.log("Airline :" + airline.code + ", and flight :" + flight);
	  if(flight.code === flight) {
...
var getAirline = function(flightNo) {
	...
	var airline =  airlines[flightCode]; 
	var flightDetails = {};
	if (!airline) {
	  console.log("Airline doesn't exists, defaulting to KLM");
	  airline =  airlines['KL']; 
	} 
	return airline;
}